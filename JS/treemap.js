...
// BLOQUE 1: CONFIGURACIÓN Y REGLAS DE COLOR
...
// BLOQUE 2: CARGAR DICCIONARIO Y LEER EXCEL
let mapping = {};
let excelDataGlobal = [];
...
// Cada nodo tiene un arreglo "details" para usarse en el modal (transferido luego como "codes")
function construirNodos(rows) {
  ...
  rows.forEach(row => {
    ...
    // Si no existe en el diccionario o su categoría es "Sin Información", lo omitimos del árbol y se consideran para los "No considerados"
...
// BLOQUE 5: PREPARAR TOOLTIP (Ventana emergente)
...
// Actualiza prepHover para generar una propiedad customText en cada nodo para agregar la lleyenda "códios CIE-10"
...
// Modal para códigos no considerados
